...
$groups   = array('hqx','zip','tar','tgz','jar','rpm','bin','dll','msi','cgi','php','jav','js','css','html','txt','msg','doc','odf','pdf','ps','ttf','wav','mid','mp3','ra','swf','mov','mpg','image','file');
$gr_hqx   = array('hqx','sit','sea');
$gr_zip   = array('zip','rar','ace','arj','cab');
$gr_tar   = array('tar','uu','uue','z');
$gr_tgz   = array('tgz','gz','bzip','bz2');
$gr_jar   = array('jar','class','cla');
...
$gr_css   = array('css');
$gr_html  = array('htm','html','shtml','mht');
...
$gr_swf   = array('swf','dcr','fla');
$gr_mov   = array('mov','qt','moov','movie');
$gr_mpg   = array('mpg','mpe','mpeg','wmv','mp2','vcs','mxu','avi','divx');
$gr_image = array('bmp','cgm','ief','djv','djvu','gd','gd2','gd2part','gif','iff','ico','jfif','jpg','jpeg','jpc','jpx','jb2','jp2','swf','swc','svg','png','psd','pbm','pnm','ppm','pgm','ras','raw','rgb','tif','tiff','wbm','wbmp','xbm','xbmp','xbitmap','xpm','xpixmap','wxd','pic','xcf','psp','xgm','tga','pix');
