...
if(is_dir($filepath)){
	...
	src=\"$img\" width=$w height=$h alt=\"<b>$filename</b><br>Folder in: $last2fold<br><br>
	...
	src=\"$img\" width=$w height=$h 
	    alt=\"<b>$filename</b><br>in: $last2fold<br>Size: $size<br>
	    Permissions: $perms<br>
	    Owner: $owner<br>
	    Group: $group<br>
	    C Time: ".date('d-m-y, G:i', $stat[10])."<br>
...
#--------UPLOAD FORM----------
print"</form><form id=f2 enctype=multipart/form-data method=POST action='windows.php' onSubmit='return upload();'>
