...
include_once("../phpnav412/functions.php");
include_once("../phpnav412/config.php");
...
include_once("../phpnav412/skin.php"); // setup skins

include_once("../phpnav412/config_patch.php"); // extra data required for "browse this"
...
.win_part_close{
  ...
  height:20px;
  width:20px;
  background-image: url('skins/atari/images/CLOSE.GIF');
}
.win_part_title{
  position:absolute;
  background-color:white;
...
.win_part_max{
  ...
  height:20px;
  width:20px;
  background-image: url('skins/atari/images/MAX.GIF');
}
.win_part_option{
  position:absolute;
  background-color:white;
...
.win_part_scrollV_up{
  ...
  height:20px;
  width:20px;
  background-image: url('skins/atari/images/UP.GIF');
}
.win_part_scrollV_down{
  ...
  height:20px;
  width:20px;
  background-image: url('skins/atari/images/DOWN.GIF');
}
.win_part_scrollH{
  position:absolute;
  background-color:white;
...
.win_part_scrollH_left{
  ...
  height:20px;
  width:20px;
  background-image: url('skins/atari/images/LEFT.GIF');
}
.win_part_scrollH_right{
  ...
  height:20px;
  width:20px;
  background-image: url('skins/atari/images/RIGHT.GIF');
}
.win_part_resize{
  position:absolute;
  background-color:white;
  ...
  height:20px;
  width:20px;
  background-image: url('skins/atari/images/RESIZE.GIF');
}
...
//new windowOrder,   X,   Y,   W,   H, W-63, H-65, H-65-42, display, id
  $winDefaults = '|0,50px,20px,600px,350px,inline,DevEditor0,3|1,450px,20px,395px,117px,none,DevOutput,2|2,50px,650px,215px,247px,none,DevCalc,2|3,40px,500px,423px,447px,inline,DevFont,2|4,40px,625px,323px,447px,inline,DevLibs,2|5,420px,20px,600px,150px,inline,DevLibHelp,2';
  loadWindows($desktop);
...
<div class=win_part_title onMouseDown="if (DesktopDialog){return(false);} clearMenus(); toFront({$windows['DevEditor0'][6]}); dragWindow({$windows['DevEditor0'][6]},event);"><table class=big border=0 cellspacing=0 cellpadding=0 align=center><tr><td align=right style="cursor:default; font-family:{$font_large}; font-size:{$font_size};">Editing {$file} in {$dir}</td></tr></table></div>
...
<div class=win_part_body><textarea style="border:none; width:100%; height:100%;" name={$windows['DevEditor0'][6]}Body id={$windows['DevEditor0'][6]}Body >{$content}</textarea></div>
...
<div class=win_part_option></div>
<div class=win_part_body style="padding:0px;"><iframe name={$windows['DevLibs'][6]}Body id={$windows['DevLibs'][6]}Body border=0 frameborder=0 width=100% height=100% style="border:1px solid gray;" src="libraries.php"></iframe></div>
<div class=win_part_scrollV><div class=win_part_scrollV_up></div><div class=win_part_scrollV_slide></div><div class=win_part_scrollV_down></div></div>
<div class=win_part_scrollH><div class=win_part_scrollH_left></div><div class=win_part_scrollH_slide></div><div class=win_part_scrollH_right></div></div>
